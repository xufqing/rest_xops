<template>
  <div class="app-container">
    <eHeader :businesses="businesses" :query="query"/>
    <!--表格渲染-->
    <tree-table v-loading="loading" :data="data" :expand-all="true" :columns="columns" border size="small">
      <el-table-column label="操作" width="150px" align="center">
        <template slot-scope="scope">
          <edit v-if="checkPermission(['admin','business_all','business_edit'])" :businesses="businesses" :data="scope.row" :sup_this="sup_this"/>
          <el-popover
...
export default {
  ...
  data() {
    return {
      ...
      delLoading: false, sup_this: this, businesses: []
    }
  },
  created() {
    this.getBusinesses()
